                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        {formData.githubRepoLink && (
                            <button type="button" onClick={() => setFormData({ ...formData, githubRepoLink: '' })} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-black">
                                ✕
                            </button>
                        )}
                    </div>
                    <div className="relative">
                        <input
                            ...
                            className="w-full bg-transparent border border-black rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#5D2E17] placeholder-gray-500"
                        />
                        {formData.hostedSiteLink && (
                            <button type="button" onClick={() => setFormData({ ...formData, hostedSiteLink: '' })} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-black">
                                ✕
                            </button>
                        )}
                    </div>
